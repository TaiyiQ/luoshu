...
pub fn main(init: std.process.Init) !void {
    var circ = try circuit.load(init.gpa, init.io, "./example/mvp.qasm");
    //var circ = try circuit.load(init.gpa, init.io, "./example/ghz-test.qasm");
    //var circ = try circuit.load(init.gpa, init.io, "./example/mvp-v2.qasm");
    defer circ.deinit();
